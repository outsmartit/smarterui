...
/**
 * @package     Joomla.Site
 * @subpackage  mod_menu adapted for UIkit (off canvas for mobile)
 *
...
$mob_menu = $app->getTemplate($myparams = true)->params->get('mobilemenutitle');
...
?>
<nav class="uk-navbar uk-margin-bottom uk-margin-top" data-uk-sticky>
    <?php if($menulogo) : ?>
    ...
    <div class="uk-navbar-brand uk-navbar-center uk-visible-small"><?php echo $mob_menu; ?></div>
</nav>   
