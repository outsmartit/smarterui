...
JHtml::addIncludePath(JPATH_THEMES . '/smarterui/helpers');
		...
		<?php if ($canEdit ||  $params->get('show_print_icon') || $params->get('show_email_icon')) : ?>
			<ul class="actions">
				<?php if ($params->get('show_print_icon')) : ?>
					<li class="print"> <?php echo JHtml::_('smartericon.print_popup',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($params->get('show_email_icon')) : ?>
					<li class="email"> <?php echo JHtml::_('smartericon.email',  $this->item, $params); ?> </li>
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<li class="edit"> <?php echo JHtml::_('smartericon.edit', $this->item, $params); ?> </li>
				<?php endif; ?>
			</ul>
		<?php endif; ?>
	<?php endif; ?>
...
<?php if ($info == 0 OR $info == 2) : ?>
	<section>
		<ul class="ui-article-info inline">
			...
			<?php if ($params->get('show_publish_date')) : ?>
                                        <li class="published"><i class="uk-icon-calendar"></i>
			...
			<?php if ($info == 0): ?>
				...
				<?php if ($params->get('show_hits')) : ?>
                                        <li class="hits"><i class="uk-icon-eye"></i>
