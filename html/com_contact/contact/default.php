...
/**
 * @package     Joomla.Site
 * @subpackage  com_contact adapted for Foundation 5
 *
...
<div class="contact<?php echo $this->pageclass_sfx ?>" itemscope itemtype="http://schema.org/Person">
    ...
    <?php if ($this->params->get('contact_vatnumber', false)) : ?>
        <div class="uk-width-small-1-1 contract-vat">
            <div class="<?php echo $this->params->get('marker_class'); ?>" >
                <?php echo $this->params->get('marker_misc'); ?>
            </div>
            <span>Ondernemingsnummer : <?php echo $this->params->get('contact_vatnumber'); ?><br/>
                RPR : <?php echo $this->params->get('contact_rpr'); ?><br/>
                Bank : <?php echo $this->params->get('contact_bankaccount'); ?><br/>
            </span>
        </div>
    <?php endif; ?>
    <!--insert additional parameters -->
