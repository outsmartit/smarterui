 ...
 * @since  1.5
 */
abstract class JHtmlSmarterIcon
{
	/**
	...
	public static function create($category, $params, $attribs = array(), $legacy = false)
	{
		...
		if ($params->get('show_icons'))
		{
			...
			{
				$text = '<i class="uk-icon-plus"></i>' . JText::_('JNEW');
			}
		}
		else
		{
	...
	public static function email($article, $params, $attribs = array(), $legacy = false)
	{
		...
		if ($params->get('show_icons'))
		{
			...
			{
				$text = '<i class="uk-icon-envelope-o"></i>' . JText::_('JGLOBAL_EMAIL');
			}
		}
		else
		{
	...
	public static function edit($article, $params, $attribs = array(), $legacy = false)
	{
		...
		else
		{
			...
			$text = '<span class="hasTooltip uk-icon-' . $icon . ' tip" title="' . JHtml::tooltipText(JText::_('COM_CONTENT_EDIT_ITEM'), $overlib, 0)
				. '"></span>'
	...
	public static function print_popup($article, $params, $attribs = array(), $legacy = false)
	{
		...
		if ($params->get('show_icons'))
		{
			...
			{
				$text = '<i class="uk-icon-print"></i>' . JText::_('JGLOBAL_PRINT');
			}
		}
		else
		{
