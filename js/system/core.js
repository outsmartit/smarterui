...
(function( Joomla, document ) {
	...
	Joomla.renderMessages = function( messages ) {
		...
		for ( type in messages ) {
			...
			// Message class
			alertClass = (type == 'notice') ? 'uk-alert-info' : 'uk-alert-' + type;
			alertClass = (type == 'message') ? 'uk-alert-success' : alertClass;
                        messagesBox.setAttribute('data-uk-alert');
                        
			messagesBox.className = 'uk-alert ' + alertClass;

			// Close button
			var buttonWrapper = document.createElement( 'a' );
			
			buttonWrapper.className = 'uk-alert-close uk-close';
